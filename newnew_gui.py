...
class MainGui(gui.Desktop):
    ...
    global spice_table, score_table
    ...
    def __init__(this, disp):
        ...
        sidebar.tr()
        spice_list = gui.List(width=150, height=100)
        sidebar.td(spice_list, align=-1, valign=-1)
        ...
        score_list = gui.List(width=150, height=100)
        sidebar.tr()
        sidebar.td(score_list, align=-1, valign=-1)
